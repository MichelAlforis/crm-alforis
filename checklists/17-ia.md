# 📋 Chapitre 17 - Intelligence Artificielle (Agent IA)

**Status :** ✅ V1 IMPLÉMENTÉ + V2 SPEC READY
**Tests :** 12/30 (40%)
**Priorité :** 🟡 Moyenne
**Bonus :** Centraliser config IA sur `/dashboard/settings/integrations`
...
### ✅ 2. Enrichissement de Données (Data Enrichment)
...
**Recommandation actuelle** : **Claude 3.5 Sonnet** (qualité + context window)
...
| Condition | Tâche Générée | Priorité |
|-----------|---------------|----------|
...
### Refactoring UX
- [ ] **Centraliser toutes les intégrations** sur `/dashboard/settings/integrations`
  - Déplacer config IA depuis `/dashboard/ai/config`
  - Ajouter sections : Outlook, LinkedIn, Google, API Keys IA
  - Layout unifié avec onglets : "Email", "CRM", "IA", "Webhooks"
  - Benefits : Une seule page pour toutes les connexions externes
