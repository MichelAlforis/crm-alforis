...
def upgrade() -> None:
    ...
    # Table: people
    # ========================================
    op.add_column('people', sa.Column('is_anonymized', sa.Boolean(), nullable=False, server_default='false"))
    op.add_column('people', sa.Column('gdpr_consent', sa.Boolean(), nullable=True))
    op.add_column('people', sa.Column('gdpr_consent_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('people', sa.Column('anonymized_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('people', sa.Column('last_activity_date', sa.DateTime(timezone=True), nullable=True))
    ...
    # Table: organisations
    # ========================================
    op.add_column('organisations', sa.Column('is_anonymized', sa.Boolean(), nullable=False, server_default='false"))
    op.add_column('organisations', sa.Column('gdpr_consent', sa.Boolean(), nullable=True))
    op.add_column('organisations', sa.Column('gdpr_consent_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('organisations', sa.Column('anonymized_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('organisations', sa.Column('last_activity_date', sa.DateTime(timezone=True), nullable=True))
