...
down_revision = None  # Base migration for email campaigns
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_campaign_emails_campaign_id"), "campaign_emails", ["campaign_id"], unique=False
    )
    op.create_index(op.f("ix_campaign_emails_status"), "campaign_emails", ["status"], unique=False)
    op.create_index(
        op.f("ix_campaign_emails_batch_number"), "campaign_emails", ["batch_number"], unique=False
    )
